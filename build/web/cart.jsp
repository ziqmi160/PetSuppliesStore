      ...
      <body>
                              ...
                              <div class="input-group mb-3 d-flex align-items-center quantity-container"
                                ...
                                <div class="input-group-prepend">
                                  <button class="btn btn-outline-black decrease" type="button"
                                    onclick="updateQuantity(<%= item.getProductId() %>, -1)">
                                    &minus;
                                  </button>
                                </div>
              ...
              <div class="col-md-6">
                <div class="row mb-5">
                  <div class="col-md-6 mb-3 mb-md-0">
                    <button class="btn btn-black btn-sm btn-block" onclick="updateCart()">
                      Update Cart
                    </button>
                  </div>
                  <div class="col-md-6">
        ...
        <script>
          function updateQuantity(productId, change) {
            const input = document.querySelector(`input[value][data-product-id="${productId}"]`);
