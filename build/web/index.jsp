...
<head>
	...
	<title>iDea Furniture Website</title>
</head>
			...
			<div class="row justify-content-between">
				<div class="col-lg-5">
					<div class="intro-excerpt">
						...
						<p class="mb-4">Stylish, affordable furniture for every room. Comfort, quality, and design in
							one place.</p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
					...
					<p class="mb-4">Our furniture is crafted with high-quality materials, combining durability, comfort,
						and timeless style to elevate every space. </p>
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-6">
					...
					<p>Choose us for expertly crafted furniture made from premium materials, offering the perfect blend
						of quality, timeless style, and lasting comfort for your home. </p>
					...
					<div class="row my-5">
						...
						<div class="col-6 col-md-6">
							<div class="feature">
								...
								<p>Something missing? tell us and we will give you a brand new one.</p>
							</div>
						</div>
		...
		<div class="container">
			<div class="row justify-content-between">
				...
				<div class="col-lg-5 ps-lg-5">
					...
					<p>We help you transform your space with modern interior design solutions, offering stylish,
						high-quality furniture that reflects your taste, enhances comfort, and brings your vision to
						life.</p>

					<ul class="list-unstyled custom-list my-4">
						<li>We bring modern style to your home.</li>
						<li>High-quality furniture for every room.</li>
									...
									<div class="col-lg-8 mx-auto">
										...
										<div class="testimonial-block text-center">
											<blockquote class="mb-5">
												<p>&ldquo;I'm really impressed with the quality and design of the
													furniture. Our living room feels completely transformed and looks
													amazing. The pieces are both stylish and comfortable. I highly
													recommend this store to anyone looking to upgrade their home.&rdquo;
												</p>
											</blockquote>

											<div class="author-info">
												<div class="author-pic">
													<img src="images/person-1.jpg" alt="Aswan Jomri" class="img-fluid">
												</div>
							...
							<div class="item">
								<div class="row justify-content-center">
									<div class="col-lg-8 mx-auto">
										...
										<div class="testimonial-block text-center">
											<blockquote class="mb-5">
												<p>&ldquo;The delivery was prompt, and the furniture matched the
													description perfectly as advertised. It's comfortable and adds a
													modern touch to my space. The whole experience was smooth and
													hassle-free. Customer service was excellent from start to
													finish.&rdquo;</p>
											</blockquote>

											<div class="author-info">
												<div class="author-pic">
													<img src="images/person-2.jpg" alt="Danial Atlas" class="img-fluid">
												</div>
							...
							<div class="item">
								<div class="row justify-content-center">
									<div class="col-lg-8 mx-auto">
										...
										<div class="testimonial-block text-center">
											<blockquote class="mb-5">
												<p>&ldquo;I was pleasantly surprised by how affordable the prices were,
													especially considering the quality. My new dining set is not only
													stylish but also very sturdy. Great value for money! I'm very happy
													with my purchase and will definitely shop here again.&rdquo;</p>
											</blockquote>

											<div class="author-info">
												<div class="author-pic">
													<img src="images/person-3.jpg" alt="Jofsyar Shri" class="img-fluid">
												</div>
