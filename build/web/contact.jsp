...
<body>
	...
	<!-- Start Hero Section -->
	<div class="hero"
		style="background-image: url('images/shop-head.jpg'); background-size: cover; background-position: center; position: relative; height: 400px;">
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-5">
					<div class="intro-excerpt">
						<h1>Contact Us</h1>
						<p class="mb-4">We're here to help! Whether you have a question about our products, need
							assistance with your order, or want design advice, the Idea team is ready to assist you.</p>
							...
							<div class="col-lg-4">
								<div class="service no-shadow align-items-center link horizontal d-flex active"
									...
									<div class="service-contents">
										<p>Lot 26483, Lebuhraya Kuala Lumpur - Seremban, Sungai Besi, 57100 Kuala
											Lumpur, Federal Territory of Kuala Lumpur</p>
