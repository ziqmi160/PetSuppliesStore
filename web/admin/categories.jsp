                            ...
                            <div class="admin-header">
                                <div class="container-fluid">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h1 class="navbar-brand mb-0">Category Management</h1>
                                        </div>
                                ...
                                <div class="container">
                                    <div class="row align-items-center">
                                        <div class="col-lg-8">
                                            ...
                                            <p>Organize your products by category, add new categories, and keep your
                                                catalog structured and easy to navigate.</p>
                                        </div>
                                        <div class="col-lg-4 text-center"><i class="fas fa-th-list"
                                            ...
                                            <% String error=(String) request.getAttribute("error"); if (error !=null &&
                                                ...
                                                <% } %>
                                                    <div class="page-header">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <h2><i class="fas fa-th-list me-2"></i>All Categories
                                                                </h2>
                                                                <p>Manage your product categories</p>
                                                            </div>
                                                            <div class="col-auto"><a
                                                                    href="AdminCategoryServlet?action=showAddForm"
                                                    ...
                                                    <div class="categories-table">
                                                        <div class="table-header"><i
                                                                class="fas fa-list me-2"></i>Category List</div>
                                                                                ...
                                                                                <td>
                                                                                    <div class="action-buttons">
                                                                                        ...
                                                                                        <form
                                                                                            ...
                                                                                            <button type="submit"
                                                                                                class="btn-delete"
                                                                                                onclick="return confirm('Are you sure you want to delete <%= category.getCategoryName() %>?');"><i
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="3">
                                                                                        <div class="empty-state">
                                                                                            ...
                                                                                            <p>Start organizing your
                                                                                                products by adding your
                                                                                                first category.</p>
