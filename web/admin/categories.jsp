        ...
        <%@ page import="com.idea.model.Category" %>
            <%@ page import="java.util.List" %>
                ...
                <head>
                    ...
                    <meta name="description" content="Admin Category Management" />
                    <meta name="keywords" content="admin, category, management, ecommerce" />
                    ...
                    <title>Category Management - iDea Admin</title>
                    ...
                    <% Admin admin=(Admin) session.getAttribute("admin"); if (admin==null) {
                        ...
                        <div class="admin-sidebar">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item"><a class="nav-link" href="AdminCustomerServlet"><i
                                            class="fas fa-users"></i> Customers</a></li>
                                <li class="nav-item"><a class="nav-link active" href="AdminCategoryServlet"><i
                        ...
                        <div class="admin-content">
                            <div class="page-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h1><i class="fas fa-th-list me-2"></i>Category Management</h1>
                                        <p>Organize your products with categories to improve customer navigation and
                                            shopping experience.</p>
                                    </div>
                                    <a href="AdminCategoryServlet?action=showAddForm" class="btn btn-primary">
                                ...
                                <% } %>
                                    ...
                                    <div class="categories-table">
                                        <div class="table-header">
                                            <h2><i class="fas fa-th-list me-2"></i>Categories List</h2>
                                            ...
                                            <% List<Category> categories = (List<Category>)
                                                    ...
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <% for (Category category : categories) { %>
                                                                <tr>
                                                                    <td><strong>#<%= category.getCategoryId() %>
                                                                        </strong></td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div class="action-buttons">
                                                                            <a href="AdminCategoryServlet?action=showEditForm&id=<%= category.getCategoryId() %>"
                                                                                class="btn btn-edit"
                                                                                title="Edit Category">
                                                                            ...
                                                                            <form action="AdminCategoryServlet"
                                                                                ...
                                                                                onsubmit="return confirm('Are you sure you want to delete <%= category.getCategoryName() %>? This action cannot be undone.');">
                                                    ...
                                                    <% } else { %>
                                                        <div class="empty-state">
                                                            ...
                                                            <p>You haven't created any categories yet. Start by adding
                                                                your first category to organize your products.</p>
                                                            <a href="AdminCategoryServlet?action=showAddForm"
