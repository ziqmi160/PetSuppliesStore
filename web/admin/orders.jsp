            ...
            <%@ page import="java.util.List" %>
                <%@ page import="java.text.SimpleDateFormat" %>
                    ...
                    <head>
                        ...
                        <meta name="description" content="Admin Order Management" />
                        ...
                        <% Admin admin=(Admin) session.getAttribute("admin"); if (admin==null) {
                            ...
                            <div class="admin-sidebar">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="AdminOrderServlet"><i
                            ...
                            <div class="admin-content">
                                <div class="page-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h1><i class="fas fa-shopping-bag me-2"></i>Order Management</h1>
                                            <p>Track, update, and manage all customer orders efficiently with a modern,
                                            ...
                                            <% } %>
                                                ...
                                                <div class="orders-table">
                                                    <div class="table-header">
                                                        <h2><i class="fas fa-shopping-bag me-2"></i>Orders List</h2>
                                                    ...
                                                    <div class="table-responsive">
                                                        <% List<Order> orders = (List<Order>)
                                                                ...
                                                                <table class="table table-hover mb-0">
                                                                    <thead>
                                                                        <tr>
                                                                            <th><i class="fas fa-hashtag me-2"></i>Order
                                                                                ID</th>
                                                                            <th><i class="fas fa-user me-2"></i>Customer
                                                                                ID</th>
                                                                            <th><i
                                                                                    class="fas fa-calendar me-2"></i>Order
                                                                                Date</th>
                                                                            <th><i
                                                                                    class="fas fa-money-bill me-2"></i>Total
                                                                                Amount</th>
                                                                            <th><i
                                                                                    class="fas fa-info-circle me-2"></i>Status
                                                                            </th>
                                                                            <th><i class="fas fa-cogs me-2"></i>Actions
                                                                            </th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <% for (Order order : orders) { String
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div
                                                                                        class="d-flex align-items-center">
                                                                                        <i class="fas fa-money-bill me-2"
                                                                                            style="color: #3b5d50;"></i>
                                                                                ...
                                                                                <td>
                                                                                    <div class="action-buttons">
                                                                                        <a href="AdminOrderServlet?action=showEditForm&id=<%= order.getOrderId() %>"
                                                                                            class="btn btn-edit"
                                                                                            title="Edit Order">
                                                                                            <i
                                                                                        ...
                                                                                        <form action="AdminOrderServlet"
                                                                                            ...
                                                                                            onsubmit="return confirm('Are you sure you want to delete Order #<%= order.getOrderId() %>? This action cannot be undone.');">
                                                                                            <input type="hidden"
                                                                                                name="action"
                                                                                                value="delete">
                                                                                            <input type="hidden"
                                                                ...
                                                                <% } else { %>
                                                                    <div class="empty-state">
                                                                        ...
                                                                        <p>There are no orders yet. Orders will appear
                                                                            here as customers make purchases.</p>
                                                                    </div>
                                                                    <% } %>
                                                    </div>
                                                </div>
