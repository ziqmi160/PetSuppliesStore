                            ...
                            <div class="admin-sidebar">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item mt-auto"><a class="nav-link"
                                            href="../LogoutServlet?role=admin"><i class="fas fa-sign-out-alt"></i>
                                            Logout</a></li>
                                </ul>
                            </div>
                                ...
                                <div class="admin-header">
                                    <div class="container-fluid">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h1 class="navbar-brand mb-0">Order Management</h1>
                                            </div>
                                    ...
                                    <div class="container">
                                        <div class="row align-items-center">
                                            <div class="col-lg-8">
                                                ...
                                                <p>Track, update, and manage all customer orders efficiently with a
                                                    modern, intuitive interface.</p>
                                            </div>
                                            <div class="col-lg-4 text-center"><i class="fas fa-shopping-bag"
                                                ...
                                                <% String error=(String) request.getAttribute("error"); if (error !=null
                                                    ...
                                                    <% } %>
                                                        <div class="page-header">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                    <h2><i class="fas fa-shopping-bag me-2"></i>All
                                                                        Orders</h2>
                                                        ...
                                                        <div class="orders-table">
                                                            <div class="table-header"><i
                                                                    class="fas fa-list me-2"></i>Order List</div>
                                                                                    ...
                                                                                    <td class="action-buttons">
                                                                                        <div class="action-buttons">
                                                                                            ...
                                                                                            <form
                                                                                                ...
                                                                                                <button type="submit"
                                                                                                    class="btn-delete"
                                                                                                    onclick="return confirm('Are you sure you want to delete Order #<%= order.getOrderId() %>?');"><i
