                            ...
                            <div class="content">
                                <div class="admin-header fixed-top" style="margin-left: 250px;">
                                    <div class="container-fluid d-flex justify-content-between align-items-center">
                                        <h1 class="navbar-brand mb-0">Edit Order</h1>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-8">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <% Order order=(Order) request.getAttribute("order"); if
                                                                (order !=null) { SimpleDateFormat dateFormat=new
                                                                ...
                                                                <form action="AdminOrderServlet" method="post">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="form-text">Update the order status
                                                                            to reflect its current state.</div>
                                                                    </div>
                                                                ...
                                                                <% } else { %>
                                                                    <div class="alert alert-warning">
                                                                        Order not found. Please go back to the orders
                                                                        list.
                                                                    </div>
                                                                    <a href="AdminOrderServlet"
                                                                        class="btn btn-secondary">
